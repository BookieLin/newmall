    ...
    <div class="login-box-body">
        ...
        <form action="/login" method="post">
            <div class="form-group has-feedback">
                <input id="loginId" name="loginId" type="text" class="form-control" placeholder="用户名">
            ...
            <div class="row">
                <div class="col-xs-8">
                    ...
                    <div class="checkbox icheck">
                        <label>
                            <input id="isAuto" name="isRemember" type="checkbox" ${"on" eq dto.isAuto ? "checked" : ""}> 自动登录
                        </label>
                    </div>
                </div>
                <!-- /.col -->
